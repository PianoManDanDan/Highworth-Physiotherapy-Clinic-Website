				...
				<div className="page-content">
					<div>
						<p>
							...
							the market town of Highworth, north east of Swindon. If you think
							we may be able to help you, the fastest way to make an appointment
							or contact us is to give us a ring. You do not need a
							doctor&apos;s referral unless it is required by your insurance
							company. Two of the physiotherapists at the clinic are also
							trained to treat animals but if you wish us to treat your pet then
							your vet must agree this in advance.
						</p>
						<p>
							...
							experienced Chartered Physiotherapists who treat sports injuries,
							back pain, neck pain, arthritis, aches, strains and pains. We are
							committed to a high level of clinical expertise and customer
							satisfaction.
						</p>
						<p>
							...
							grade II listed building in the High Street of Highworth in 2003.
							It is conveniently situated between a pub and a bakery for after
							treatment refreshments! We have three fully equipped treatment
							rooms, including one on the ground floor for patients unable to
							use the stairs.
						</p>
					</div>
					...
					<div>
						...
						<p>
							...
							depending on the condition being treated, and this time also
							includes time to write up your notes.
						</p>
						<p>
							{/* TODO: Reword */}
							...
							recommend further treatments. You will also be given advice on
							self management of your condition and may be given exercises to
							carry out yourself at home.
						</p>
						<p>
							It is best to wear loose fitting clothing for your treatments and
							your physiotherapist may require you to remove some clothing to
							assist in the assessment and treatment.
						</p>
						<p>
					...
					<div className="insurance">
						...
						advantage of this, please check with your insurance provider to see
						if we are an approved provider.
					</div>
				</div>
			</div>
		</div>
