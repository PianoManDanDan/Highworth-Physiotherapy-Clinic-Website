					...
					<div className="page-content">
						<div>
							...
							<p>
								...
								massage, advice, exercise and electrotherapy. When appropriate,
								a lot of time is spent teaching the patient self help exercises
								so that they can manage their own condition. All the
								physiotherapists at this practice are experienced Chartered
								Physiotherapists who treat sports injuries, back pain, neck
								pain, arthritis, aches, strains and pains. We are committed to a
								high level of clinical expertise and customer satisfaction.
							</p>
							<p>
								All our physiotherapists undertake at least 25 hours post
								graduate education every year.
							</p>
							<p>
								After qualification many physiotherapists go on to train in
								specialist areas including acupuncture, pilates and animal
								therapy. As we have several physiotherapists at the clinic, with
								a range of different specialisms, we may transfer you to a
								different physiotherapist within the clinic whose skills, we
								believe, will more successfully treat your condition.
							</p>
						</div>
						...
						<div>
							...
							<div>
								...
								<p>
									...
									area. However this condition is not restricted to tennis
									players but can affect golfers, gardeners and factory workers
									who strain their arm. The condition can be treated with manual
									therapy, ultrasound and often the use of an arm brace can help
							...
							<div>
								...
								<p>
									These can have a variety of causes from poor posture to
									whiplash and even uneven leg length. Most can be successfully
									treated with a combination of manual therapy, advice, postural
							...
							<div>
								...
								<p>
									...
									Physiotherapy can therefore make life much more comfortable
									and even delay or prevent the need for surgery.
								</p>
							</div>
							<div>
								...
								<p>
									...
									the first choice treatment upcoming events e.g. a marathon or
									a football tournament don&apos;t allow this. Physiotherapy can
									...
									initial treatment and follow up rehabilitation of these types
									of injuries.
								</p>
							</div>
						</div>
						...
						<div>
							...
							<div>
								...
								<p>
									...
									They are usually injected into the joint of the surrounding
									soft tissue. Sometimes they are used alone, other times they
									will be followed by physiotherapy. Reducing pain and swelling
									with a steroid injection can help make the physiotherapy work
									better. The steroid injection is usually combined with local
									anaesthetic. Local anaesthetic is used to increase the volume
									of the injection and help us know that the injection is in the
									right place.
								</p>
							</div>
							<div>
								...
								<p>
									...
									weeks for the benefits to take effect. The benefit usually
							...
							<div>
								...
								<p>
									...
									for the first 3 to 7 days. Try to avoid activities that make
									the symptoms worse. Limit walking and don&apos;t participate
									in sports.
								</p>
							</div>
						</div>
						...
						<div>
							...
							<p>
								Excessive pronation of the foot (flat feet) causes the arch of
								the foot to flatten and can result in heel, knee, hip and back
								pain. It is very common and in most cases can be treated by a
								...
								discrepancies can also be corrected with appropriately
								positioned additional wedges. For more complicated conditions we
								can refer you to a specialist podiatrist.
							</p>
